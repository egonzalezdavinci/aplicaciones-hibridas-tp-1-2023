...
import {checkJudge, checkGame, checkVote} from '../../middleware/vote-check.js';
...
route.get('/votes/game/:idGame', controllersVotes.getViewVotesId);//ver por id del juego votos
route.get('/vote/:idJudge/games', controllersVotes.getVotes);//ver por id del jurado los votos
route.post('/vote/:idJudge/:idGame/game',[checkJudge, checkGame, checkVote], controllersVotes.createdVotes);
